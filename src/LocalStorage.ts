...
export class LocalStorageService {
    ...
    public saveSites(id : string, data : Array<{name: string, url: string, pinned: boolean, path: string}>) {
        let json = "";
    ...
    public getValue(id : string) : Array<{name: string, url: string, pinned: boolean, path: string}>{
